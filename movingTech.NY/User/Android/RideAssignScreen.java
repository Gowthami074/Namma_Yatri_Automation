...
//		parkingChargesPopUp();
		rideOTP =  driver1.findElement(AppiumBy.xpath("//android.widget.Button[@content-desc='Hamburger Menu']/ancestor::android.view.ViewGroup//android.widget.TextView[contains(@text, 'OTP')]")).getText();
